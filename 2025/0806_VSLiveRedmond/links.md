# Links from VSLive! @ Microsoft HQ 2025

Date: **August 2025**

## Get started building native apps for Windows with WinUI and Windows App SDK
...
- [WinUI Documentation](https://learn.microsoft.com/windows/apps/winui/winui3/)
...
- [Fluent 2 Design System - Start Developing](https://fluent2.microsoft.design/get-started/develop)
- [WinUI on GitHub](https://github.com/microsoft/microsoft-ui-xaml)
...
- [Using the .NET MAUI Blazor Hybrid control in a WinUI project](https://egvijayanand.in/2023/03/29/dotnet-maui-blazor-hybrid-winui-3/)
