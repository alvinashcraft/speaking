...
Here are some useful links related to my AI Dev Gallery session.

### AI Dev Gallery links

- [AI Dev Gallery on GitHub](https://github.com/microsoft/ai-dev-gallery/)
- [AI Dev Gallery in Microsoft Store](http://aka.ms/ai-dev-gallery-store)
- [Submit an issue](https://github.com/microsoft/AI-Dev-Gallery/issues)

### Windows AI links

- [Choose your Windows AI solution](https://learn.microsoft.com/windows/ai/windows-ai-comparison)
- [Microsoft Foundry on Windows documentation](https://learn.microsoft.com/windows/ai/overview)
...
- [Copilot+ PC dev guide](https://learn.microsoft.com/windows/ai/npu-devices/)
- [Get started with Windows ML](https://learn.microsoft.com/windows/ai/new-windows-ml/get-started?tabs=csharp)
- [Latest Windows App SDK downloads](https://learn.microsoft.com/windows/apps/windows-app-sdk/downloads)
