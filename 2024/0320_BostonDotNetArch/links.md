# Links from my Boston .NET Architecture User Group presentation
...
- [Using WebView 2 in WinUI 3 apps](https://learn.microsoft.com/microsoft-edge/webview2/get-started/winui)
